...
export function DocumentEditor({ document, onSave, onDelete, onBack, allDocuments, linkedCourseTitle, onOpenCourse }: DocumentEditorProps) {
  ...
  const parseMarkdown = (text: string) => {
    if (!text.trim()) return <p className="text-warmgray-300 italic font-serif">Empty page. Start writing...</p>;
